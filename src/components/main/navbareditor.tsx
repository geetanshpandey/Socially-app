      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="">
          <DropdownMenu>
            ...
            <DropdownMenuContent className="bg-white dark:bg-gray-700 shadow-lg rounded-md p-2">
              <DropdownMenuItem>
                <a href="#" className="block px-4 py-2 text-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600">
                  Dashboard
                </a>
              </DropdownMenuItem>
              <DropdownMenuItem>
